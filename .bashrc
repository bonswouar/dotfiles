...
alias pdu='pdu  --top-down'
alias sgdu='sudo gdu --config-file=$HOME/.config/gdu/gdu.yaml'
...
#__conda_setup="$('/home/bonswouar/miniconda3/bin/conda' 'shell.bash' 'hook' 2> /dev/null)"
#if [ $? -eq 0 ]; then
#    eval "$__conda_setup"
#else
#    if [ -f "/home/bonswouar/miniconda3/etc/profile.d/conda.sh" ]; then
#        . "/home/bonswouar/miniconda3/etc/profile.d/conda.sh"
#    else
#        export PATH="/home/bonswouar/miniconda3/bin:$PATH"
#    fi
#fi
#unset __conda_setup
## <<< conda initialize <<<
